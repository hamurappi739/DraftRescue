...
- Phase-4 runners now disable MSBuild node reuse for their bounded invocation and keep process ownership explicit, reducing cross-run contamination risk; cleanup remains scoped to newly owned windowless processes.
